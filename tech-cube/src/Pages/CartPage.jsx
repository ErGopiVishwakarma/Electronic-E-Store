...
const CartPage = () => {
  ...
  return (
    status ? <ProductPage /> :
      <Box mb={'130px'} display={"flex"} flexDirection={{ base: 'column', sm: cart.length>0 && "row", md: "column", lg: cart.length>0 && 'row' }}  paddingTop={"90px"} px={'3%'}>

        <Box width={{ base: "full", sm: 'sm', md: '2xl', lg: '4xl' }}  minW={'full'} >
