...
const PaymentPopup = () => {
  ...
  const textColor = text==='dark'?'gray.100':'blackAlpha.900'
    ...
    return (
        <Flex w='100%' p='3%'  pt="90px" direction={{base:'column',sm:'column',md:'row',lg:'row'}}>
            <Flex w='50%' px="100px">
            ...
            <Flex w='50%' alignItems='center' justifyContent={'center'}>
                <Image src="https://blog.2checkout.com/wp-content/uploads/2020/07/payment-gateway-security-features-1024x799.png" w='90%' />
            </Flex>
        </Flex>
    )
}
